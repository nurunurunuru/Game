    ...
    <section className="py-10">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <h3 className="text-2xl font-semibold text-gray-800 mb-6">
          Booking <span className="text-secondary">List</span>
        </h3>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-2 text-sm text-gray-600 grid grid-cols-2 gap-2">
                    ...
                    <p><span className="font-semibold">Town-Hall:</span> {item.size}</p>
                    <p><span className="font-semibold">Date:</span> {new Date(item.date).toDateString()}</p>
                    <p><span className="font-semibold">Booked:</span> {item.paymentMethod}</p>
