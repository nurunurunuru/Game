    ...
    <section>
      <form onSubmit={onSubmitHandler} className='max-padd-container'>
        ...
        <div className='flex flex-col xl:flex-row gap-20 xl:gap-28'>
          ...
          <h3 className='h3'>Booking Information</h3>
         ...
         <div className='flex flex-1 flex-col '>
          ...
          {/* Payment Methode */}
          <div className='my-6'>
            <h3 className='bold-20 mb-5'>Booking <span className='text-secondary'>Method</span></h3>
            <div className='flex gap-3'>
              <div onClick={()=> setMethod('stripe')} className={`${method === 'stripe' ? "text-secondary !font-bold" : ""}`}></div>
              <div onClick={()=> setMethod('cod')} className={`${method === 'cod' ? "text-secondary !font-bold" : ""} btn-light !py-1 cursor-pointer`}>Confirm Booking</div>
            </div>
          </div>
          <div className=''>
            <button type='submit' onClick={()=> navigate('/orders')} className='btn-secondary'>Book Now</button>
          </div>
         </div>
        </div>
       </div>
